...
import {Keyboard} from "demo/widgets/keyboard/keyboard";
...
export function render(opt_templateParams, opt_options) {
	...
	var __p = '';
	__p += '<div class="s-custom-input__title">Custom input - URL</div>\n<div class="s-custom-input__input-wrapper" data-export-id="inputWrap">\n\t<div class="s-custom-input__input _not-changed" data-component="' +
	 cutejs.includeInline('component', DivInput,  {}, "input", templatesData) +
	'"></div>\n</div>\n\n' +
	 cutejs.include('component', Keyboard,  {}, "keyboard", templatesData) +
	'\n';
